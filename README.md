...
A personal “vibe-coding” project: a ruthless, append-only **typewriter mode** writing app. Even this readme is vibe coded. 
No editing, no excuses — stop typing and everything dies.
...
Type continuously.  
Never edit.  
If you hesitate too long → **FAILED** and everything you have typed will be lost.
...
- **Focus mode**  
  Hide the UI chrome and just write.
...
## 🚀 Running It (for my own reference)

This project was created with the Electron + React quick-start.
